...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 257.0, 135.5, 43.0, 15.0 ],
					"presentation" : 1,
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "Orange Decay",
...
, 			{
				"box" : 				{
					...
					"id" : "obj-10",
					"legend" : 0,
					"linecolor" : [ 1.0, 0.470588, 0.0, 1.0 ],
					"linethickness" : 3.06,
					"maxclass" : "function",
					"mode" : 1,
					"numinlets" : 1,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 407.333252000000016, 450.5, 200.0, 100.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 109.0, 54.0, 155.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 276.0, 574.0, 43.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 199.0, 4.1875, 43.0, 17.0 ],
					"text" : "Sustain",
					"textcolor" : [ 1.0, 0.469999998807907, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 276.0, 521.0, 36.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 181.5, 211.5, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 236.0, 312.0, 93.0, 22.0 ],
					"text" : "s ---mixSwitch2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.0, 211.5, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 372.0, 135.5, 43.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 202.0, 18.5625, 39.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Orange Sustain",
							"parameter_initial_enable" : 1,
...
,
					"patching_rect" : [ 407.333252000000016, 249.5, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Orange FX Expand",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1110.0, 283.5, 87.0, 22.0 ],
					"text" : "s ---orangeBal"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -50.0,
							"parameter_longname" : "Orange FX Balance",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 50.0,
							"parameter_initial" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1235.0, 323.5, 94.0, 22.0 ],
					"text" : "s ---orangeAmp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 979.0, 283.5, 110.0, 22.0 ],
					"text" : "s ---orangeExpand"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -40.0,
							"parameter_longname" : "Orange FX Amp",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 40.0,
							"parameter_initial" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1179.0, 148.0, 125.0, 22.0 ],
					"text" : "r ---orangeMixerBang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1330.0, 285.0, 127.0, 22.0 ],
					"text" : "s ---orangeDryWet"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 888.0, 323.5, 100.0, 22.0 ],
					"text" : "s ---orangeWidth"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Orange FX Width",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Orange FX Dry/Wet",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 100.0,
							"parameter_initial" : [ 100 ],
