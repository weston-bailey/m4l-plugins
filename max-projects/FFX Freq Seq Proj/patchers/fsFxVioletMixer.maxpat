...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 26.0, 155.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.5, 289.5, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.0, 390.0, 93.0, 22.0 ],
					"text" : "s ---mixSwitch7"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.0, 544.0, 43.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 167.0, 5.6875, 43.0, 17.0 ],
					"text" : "Sustain",
					"textcolor" : [ 1.0, 0.0, 0.5, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.0, 491.0, 36.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.0, 289.5, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 431.0, 213.5, 43.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 170.0, 20.0625, 39.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Violet Sustain",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 380.0, 213.5, 43.0, 15.0 ],
					"presentation" : 1,
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "Violet Decay",
							"parameter_initial_enable" : 1,
...
,
					"patching_rect" : [ 466.333252000000016, 327.5, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-10",
					"legend" : 0,
					"linecolor" : [ 1.0, 0.0, 0.501961, 1.0 ],
					"linethickness" : 3.06,
					"maxclass" : "function",
					"mode" : 1,
					"numinlets" : 1,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 466.333252000000016, 566.5, 200.0, 100.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Violet FX Expand",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1110.0, 283.5, 77.0, 22.0 ],
					"text" : "s ---violetBal"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -50.0,
							"parameter_longname" : "Violet FX Balance",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 50.0,
							"parameter_initial" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1235.0, 323.5, 85.0, 22.0 ],
					"text" : "s ---violetAmp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 979.0, 283.5, 101.0, 22.0 ],
					"text" : "s ---violetExpand"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -40.0,
							"parameter_longname" : "Violet FX Amp",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 40.0,
							"parameter_initial" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1179.0, 148.0, 115.0, 22.0 ],
					"text" : "r ---violetMixerBang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1330.0, 271.5, 100.0, 22.0 ],
					"text" : "s ---violetDryWet"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 888.0, 323.5, 91.0, 22.0 ],
					"text" : "s ---violetWidth"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Violet FX Width",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Violet FX Dry/Wet",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 100.0,
							"parameter_initial" : [ 100 ],
