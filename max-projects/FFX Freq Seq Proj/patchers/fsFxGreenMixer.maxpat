...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 88.333252000000002, 54.0, 155.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 216.5, 142.5, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 271.0, 243.0, 93.0, 22.0 ],
					"text" : "s ---mixSwitch4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 222.0, 397.0, 43.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 183.0, 4.1875, 43.0, 17.0 ],
					"text" : "Sustain",
					"textcolor" : [ 0.0, 1.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 222.0, 344.0, 36.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.0, 142.5, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 407.0, 66.5, 43.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 186.0, 18.5625, 39.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Green Sustain",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 356.0, 66.5, 43.0, 15.0 ],
					"presentation" : 1,
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "Green Decay",
							"parameter_initial_enable" : 1,
...
,
					"patching_rect" : [ 442.333252000000016, 180.5, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-1",
					"legend" : 0,
					"linecolor" : [ 0.219608, 1.0, 0.078431, 1.0 ],
					"linethickness" : 3.06,
					"maxclass" : "function",
					"mode" : 1,
					"numinlets" : 1,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 442.333252000000016, 429.5, 200.0, 100.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Green FX Expand",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1110.0, 283.5, 80.0, 22.0 ],
					"text" : "s ---greenBal"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -50.0,
							"parameter_longname" : "Green FX Balance",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 50.0,
							"parameter_initial" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1235.0, 323.5, 87.0, 22.0 ],
					"text" : "s ---greenAmp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 979.0, 283.5, 103.0, 22.0 ],
					"text" : "s ---greenExpand"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -40.0,
							"parameter_longname" : "Green FX Amp",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 40.0,
							"parameter_initial" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1179.0, 148.0, 118.0, 22.0 ],
					"text" : "r ---greenMixerBang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1330.0, 285.0, 102.0, 22.0 ],
					"text" : "s ---greenDryWet"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 888.0, 323.5, 93.0, 22.0 ],
					"text" : "s ---greenWidth"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Green FX Width",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Green FX Dry/Wet",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 100.0,
							"parameter_initial" : [ 100 ],
