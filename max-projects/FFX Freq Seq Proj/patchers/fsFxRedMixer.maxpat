...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 67.0, 11.0, 155.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.5, 274.5, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 375.0, 93.0, 22.0 ],
					"text" : "s ---mixSwitch1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 234.0, 529.0, 43.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 212.0, 2.6875, 43.0, 17.0 ],
					"text" : "Sustain",
					"textcolor" : [ 1.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 234.0, 476.0, 36.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Red FX Expand",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1110.0, 283.5, 67.0, 22.0 ],
					"text" : "s ---redBal"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -50.0,
							"parameter_longname" : "Red FX Balance",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 50.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1235.0, 289.0, 74.0, 22.0 ],
					"text" : "s ---redAmp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 979.0, 283.5, 90.0, 22.0 ],
					"text" : "s ---redExpand"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1179.0, 148.0, 105.0, 22.0 ],
					"text" : "r ---redMixerBang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1330.0, 285.0, 89.0, 22.0 ],
					"text" : "s ---redDryWet"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 888.0, 283.5, 80.0, 22.0 ],
					"text" : "s ---redWidth"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Red FX Width",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Red FX Dry/Wet",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 100.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 274.5, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 416.0, 198.5, 43.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 215.0, 17.0625, 39.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Red Sustain",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 365.0, 198.5, 43.0, 15.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 204.0, 310.0, 93.0, 22.0 ],
									"text" : "pack 2 5000. 0."
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 127.0, 230.0, 56.0, 22.0 ],
									"text" : "t b f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 385.0, 83.0, 21.0 ],
									"text" : "setcurve 1 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 50.0, 347.0, 30.0, 22.0 ],
									"text" : "t b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "float" ],
									"patching_rect" : [ 50.0, 230.0, 56.0, 22.0 ],
									"text" : "t b f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 310.0, 93.0, 22.0 ],
									"text" : "pack 1 1000. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 61.0, 464.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 451.333252000000016, 312.5, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 451.333252000000016, 535.5, 200.0, 100.0 ],
					"presentation" : 1,
