...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "FX Ouput",
					"textcolor" : [ 0.759999990463257, 0.0, 0.889999985694885, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 179.0, 5.6875, 43.0, 17.0 ],
					"text" : "Sustain",
					"textcolor" : [ 0.759999990463257, 0.0, 0.889999985694885, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 182.0, 20.0625, 39.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Indigo Sustain",
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "Indigo Decay",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-10",
					"legend" : 0,
					"linecolor" : [ 0.760784, 0.0, 0.890196, 1.0 ],
					"linethickness" : 3.06,
					"maxclass" : "function",
					"mode" : 1,
					"numinlets" : 1,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 466.333252000000016, 512.5, 200.0, 100.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Indigo FX Expand",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1110.0, 283.5, 81.0, 22.0 ],
					"text" : "s ---indigoBal"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -50.0,
							"parameter_longname" : "Indigo FX Balance",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 50.0,
							"parameter_initial" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1235.0, 323.5, 89.0, 22.0 ],
					"text" : "s ---indigoAmp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 979.0, 283.5, 105.0, 22.0 ],
					"text" : "s ---indigoExpand"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -40.0,
							"parameter_longname" : "Indigo FX Amp",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 40.0,
							"parameter_initial" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1179.0, 148.0, 119.0, 22.0 ],
					"text" : "r ---indigoMixerBang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1330.0, 271.5, 127.0, 22.0 ],
					"text" : "s ---indigoDryWet"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 888.0, 323.5, 95.0, 22.0 ],
					"text" : "s ---indigoWidth"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Indigo FX Width",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Indigo FX Dry/Wet",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 100.0,
							"parameter_initial" : [ 100 ],
