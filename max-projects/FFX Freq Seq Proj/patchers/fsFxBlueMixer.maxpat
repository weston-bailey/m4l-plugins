...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 79.0, 26.0, 155.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 246.0, 544.0, 43.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 186.0, 2.6875, 43.0, 17.0 ],
					"text" : "Sustain",
					"textcolor" : [ 0.0, 1.0, 1.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 246.0, 491.0, 36.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 189.0, 17.0625, 39.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Blue Sustain",
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 471.333252000000016, 502.5, 200.0, 100.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Blue FX Expand",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1110.0, 283.5, 72.0, 22.0 ],
					"text" : "s ---blueBal"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -50.0,
							"parameter_longname" : "Blue FX Balance",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 50.0,
							"parameter_initial" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1235.0, 323.5, 79.0, 22.0 ],
					"text" : "s ---blueAmp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 979.0, 283.5, 95.0, 22.0 ],
					"text" : "s ---blueExpand"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmin" : -40.0,
							"parameter_longname" : "Blue FX Amp",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 40.0,
							"parameter_initial" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1179.0, 148.0, 110.0, 22.0 ],
					"text" : "r ---blueMixerBang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1330.0, 285.0, 94.0, 22.0 ],
					"text" : "s ---blueDryWet"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 888.0, 323.5, 85.0, 22.0 ],
					"text" : "s ---blueWidth"
				}
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Blue FX Width",
							"parameter_initial_enable" : 1,
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "Blue FX Dry/Wet",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 100.0,
