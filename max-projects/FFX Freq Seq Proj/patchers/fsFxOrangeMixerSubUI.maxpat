...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 417.399993999999992, 179.166686999999996, 57.0, 22.0 ],
					"text" : "r initText"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3105.0, 607.5, 112.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3105.0, 554.0, 40.0, 22.0 ],
					"text" : "r ---r2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.399993999999992, 498.200012000000015, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.399993999999992, 581.200012000000015, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.399993999999992, 262.0, 92.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.399993999999992, 330.200012000000015, 92.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 793.733397999999966, 211.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 793.733397999999966, 354.633301000000017, 136.0, 35.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 1284.5166015625, 419.0833740234375, 136.0, 35.0 ],
					"text" : "definecolor 1. 0.47 0. 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"subplots" : [ 						{
							"color" : [ 1.0, 0.469999998807907, 0.0, 1.0 ],
							"thickness" : 2.0,
							"point_style" : "none",
							"line_style" : "linear",
							"number_style" : "none",
...
, 						{
							"color" : [ 1.0, 0.469999998807907, 0.0, 0.5 ],
							"thickness" : 2.0,
							"point_style" : "none",
							"line_style" : "linear",
							"number_style" : "none",
...
, 			{
				"box" : 				{
					...
					"text" : "FB Filter",
					"textcolor" : [ 1.0, 0.469999998807907, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					"activebgcolor" : [ 1.0, 0.47, 0.0, 1.0 ],
					"activebgoncolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"activetextoncolor" : [ 1.0, 0.47, 0.0, 1.0 ],
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "Orange Stutter Inactive Mode",
...
,
					"text" : "Mute",
					"texton" : "Bypass",
					"varname" : "Orange Stutter Inactive Mode"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-32",
					"ignoreclick" : 1,
					"labeltextcolor" : [ 1.0, 0.470588235294118, 0.0, 1.0 ],
					"maxclass" : "live.text",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_type" : 2,
							"parameter_linknames" : 1,
							"parameter_longname" : "Orange Reverse Switch",
							"parameter_initial_enable" : 1
						}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_type" : 2,
							"parameter_linknames" : 1,
							"parameter_longname" : "Orange Filter Switch",
							"parameter_initial_enable" : 1
						}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 2363.299805000000106, 418.700012000000015, 81.0, 14.0 ],
					"presentation" : 1,
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmax" : 1.0,
							"parameter_initial" : [ 1.0 ],
							"parameter_shortname" : "PS Switch",
							"parameter_enum" : [ "On", "Off" ],
							"parameter_type" : 2,
							"parameter_linknames" : 1,
							"parameter_longname" : "Orange PS Switch",
							"parameter_initial_enable" : 1
						}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_type" : 2,
							"parameter_linknames" : 1,
							"parameter_longname" : "Orange Stutter Switch",
							"parameter_initial_enable" : 1
						}
...
,
					"text" : "Stutter",
					"texton" : "Stutter",
					"varname" : "Orange Stutter Switch"
				}

			}
, 			{
				"box" : 				{
					"activedialcolor" : [ 1.0, 0.47, 0.0, 1.0 ],
					"activeneedlecolor" : [ 1.0, 0.47, 0.0, 1.0 ],
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "Orange Probability Increase",
							"parameter_initial_enable" : 1
						}
...
,
					...
					"tricolor" : [ 1.0, 0.47, 0.0, 1.0 ],
					"varname" : "Orange Probability Increase"
				}
...
, 			{
				"box" : 				{
					"activebgcolor" : [ 0.239216, 0.254902, 0.278431, 0.37 ],
					"activebgoncolor" : [ 1.0, 0.47, 0.0, 1.0 ],
					"bgcolor" : [ 1.0, 0.47, 0.0, 1.0 ],
					"bgoncolor" : [ 1.0, 0.47, 0.0, 1.0 ],
					"bordercolor" : [ 1.0, 0.47, 0.0, 1.0 ],
					"focusbordercolor" : [ 1.0, 0.47, 0.0, 1.0 ],
					"id" : "obj-89",
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_linknames" : 1,
							"parameter_longname" : "Orange Stutter Change",
							"parameter_initial_enable" : 1
						}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_type" : 2,
							"parameter_linknames" : 1,
							"parameter_longname" : "Orange Delay Pitch Mode",
							"parameter_initial_enable" : 1
						}
...
,
					...
					"varname" : "Orange Delay Pitch Mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1072.90002400000003, 369.700012000000015, 73.0, 22.0 ],
					"text" : "outputvalue"
				}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_type" : 2,
							"parameter_linknames" : 1,
							"parameter_longname" : "Orange Delay Mode",
							"parameter_initial_enable" : 1
						}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmax" : 1.0,
							"parameter_initial" : [ 0.0 ],
							"parameter_shortname" : "Orange Delay Sync",
							"parameter_enum" : [ "Free", "Sync" ],
							"parameter_defer" : 1,
							"parameter_type" : 2,
							"parameter_linknames" : 1,
							"parameter_longname" : "Orange Delay Sync",
							"parameter_initial_enable" : 1
						}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_mmax" : 1.0,
							"parameter_initial" : [ 0.0 ],
							"parameter_shortname" : "Orange Delay Filter",
							"parameter_enum" : [ "Off", "Filter" ],
							"parameter_type" : 2,
							"parameter_linknames" : 1,
							"parameter_longname" : "Orange Delay Filter"
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 396.399993999999992, 296.200012000000015, 155.0, 22.0 ],
					"text" : "paramRand ---orangeRand"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 187.399993999999992, 544.200012000000015, 155.0, 22.0 ],
					"text" : "paramRand ---orangeRand"
				}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_unitstyle" : 5,
							"parameter_linknames" : 1,
							"parameter_longname" : "Orange LFO Duty",
							"parameter_initial_enable" : 1
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 3369.283446999999796, 161.399993999999992, 56.0, 22.0 ],
					"text" : "sel bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 25,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 421.5, 71.0, 3028.600586000000021, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 577.90002400000003, 296.200012000000015, 50.0, 18.0 ],
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_type" : 2,
							"parameter_linknames" : 1,
							"parameter_longname" : "Orange LFO Shape"
						}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_type" : 2,
							"parameter_linknames" : 1,
							"parameter_longname" : "Orange LFO Sync",
							"parameter_initial_enable" : 1
						}
...
, 			{
		...
		"parameters" : 		{
			"obj-1054" : [ "Orange Delay Pitch Mode", "Pitch Mode", 0 ],
			"obj-1053" : [ "Orange Delay Mode", "Delay Mode", 0 ],
			"obj-1055" : [ "Orange Delay Sync", "Orange Delay Sync", 0 ],
			"obj-1056" : [ "Orange Delay Filter", "Orange Delay Filter", 0 ],
			"obj-89" : [ "live.button[6]", "live.button", 0 ],
			"obj-1051" : [ "Orange LFO Duty", "Duty", 0 ],
			"obj-33" : [ "live.text[172]", "live.text", 0 ],
			"obj-1060" : [ "Orange Reverse Switch", "Reverse Prob", 0 ],
			"obj-1062" : [ "Orange Filter Switch", "Filter Prob", 0 ],
			"obj-1061" : [ "Orange PS Switch", "PS Switch", 0 ],
			"obj-37" : [ "live.text[174]", "live.text", 0 ],
			"obj-32" : [ "live.text[171]", "live.text", 0 ],
			"obj-1050" : [ "Orange LFO Shape", "Shape", 0 ],
			"obj-1052" : [ "Orange LFO Sync", "Sync", 0 ],
			"obj-1063" : [ "Orange Stutter Inactive Mode", "Inactive Mode", 0 ],
			"obj-1059" : [ "Orange Stutter Switch", "Stutter Prob", 0 ],
			"obj-1058" : [ "Orange Probability Increase", "Prob Inc", 0 ],
			"obj-36" : [ "live.text[173]", "live.text", 0 ],
			"obj-1057" : [ "Orange Stutter Change", "Change", 0 ],
			"parameterbanks" : 			{
